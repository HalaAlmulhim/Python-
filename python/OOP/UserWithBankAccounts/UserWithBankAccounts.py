...
hala.saving_account.deposit(100).display_account_info()
# METHOD 2: depositing 100, and displaying account balance through User().display_user_balance()
hala.make_deposit(100, "saving").display_user_balance("saving")
